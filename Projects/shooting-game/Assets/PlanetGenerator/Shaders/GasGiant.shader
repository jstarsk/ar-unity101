...
/////// Diffuse:
                ...
                float node_362 = (_Cyclones*_cyclone.a*0.6);
                ...
                float2 _finalUV = ((_cyclonesUV+(_Flow*time.r)*float2(0.1,0))+((1.0 - (_poles*_poles*_poles*_poles))*_noise.a)*float2(0.05,0));
                float4 _finalMap = tex2D(_Noise,TRANSFORM_TEX(_finalUV, _Noise));
                float3 _color = TriLerp( _finalMap.a , _Color1.rgb , _Color2.rgb , _Color3.rgb );
